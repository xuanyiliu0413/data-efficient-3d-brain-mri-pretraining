...
This repository is intended as a lightweight project overview rather than a complete research release.

Medical imaging datasets, patient-level information, pretrained checkpoints, internal experiment logs, and non-redistributable research code are not included.

The project is being considered for further research development, so the complete experimental implementation is currently maintained privately.
...
MSc dissertation completed. Further research development under consideration.
